...
const Invoice = () => {
    ...
    return (
        ...
        <div
            id="invoice"
            className="bg-white border rounded-lg shadow-lg px-6 py-8 max-w-xl mx-auto mt-8">
            ...
            <div>
                <button
                    onClick={PrintPDF}
                    id="printButton"
                    className="flex items-center justify-center mx-auto p-4">Print</button>
            </div>
        </div>
