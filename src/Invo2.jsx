...
class Invoice extends React.Component {
    printPDF = () => {
        ...
        printButton.style.display = 'none'; // Hide print button before printing
        if (printText) printText.remove(); // Remove print text
        window.print();
        printButton.style.display = 'block'; // Restore print button after printing
    }

    render() {
        return (
            <div>
                <div id="invoice" className="bg-white border rounded-lg shadow-lg px-6 py-8 max-w-xl mx-auto mt-8">
                    ...
                    <div className="text-gray-700 mb-2" id="printText">Thank you for your business!</div>
                    <div className="text-gray-700 text-sm">Please remit payment within 30 days.</div>
                </div>
                <button onClick={this.printPDF} id="printButton" className="flex items-center justify-center mx-auto p-4">Print</button>
            </div>
        );
    }
}
